  ...
  return (
    <>
      ...
      <div className="app__work-filter">
        {["UI/UX", "Web App", "Mobile App", "React App", "All"].map(
          (item, index) => (
            <div
              key={index}
      ...
      >
        {filterWork.map((workItem, index) => (
          <div className="app__work-item app__flex" key={index}>
            <div className="app__work-item_img app__flex">
              ...
              >
                <a href={workItem.projectLink} target="blank" rel="noreferrer">
                  <motion.div
                ...
                <a href={workItem.codeLink} target="blank" rel="noreferrer">
                  <motion.div
                    whileInView={{ scale: [0, 1] }}
                    whileHover={{ scale: [1, 0.9] }}
                    transition={{
